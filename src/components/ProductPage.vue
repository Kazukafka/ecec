...
<div class="ProductPage">
  ...
  <b-row>
    ...
    <b-col cols="7">
      ...
      <p>
        <b-button-group>
          <b-button v-for="option in product.options" :key="option.name" @click="changeOption(option)">
            {{option.title}}
          </b-button>
        </b-button-group>
      </p>
      ...
      <p>
        <b-button size="lg" variant="success" @click="addToCart"> Add To cart ${{this.qty*this.selectedOption.price}} </b-button>
      ...
      <p>
        <b-alert :show="showConfirmation" variant="info">
          ...
          <p>You Added Success!</p>
          <p><b-button to="/cart">Go to CheckList</b-button></p>
        </b-alert>
      </p>
    </b-col>
  </b-row>
